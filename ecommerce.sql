...
--
-- Host: localhost
-- Generation Time: Mar 22, 2023 at 06:59 PM
...
('admin', 'Admin', 'mdi mdi-account-lock', NULL, 1, 1),
...
('setting', 'Setting', 'mdi mdi-tools', NULL, 3, 1),
('site_setting', 'Site Setting', 'bx bx-cog', NULL, 2, 1);
