...
<div class="variant-container">
    ...
    <div class="row g-2">
       ...
       <div class="variant-inner col" style="max-width: 70px;">
            ...
            <div class="form-group">
                <span class="default-image" data-image="variant-image-<?php echo e(\Str::slug(implode('-', $items))); ?>">
        ...
        <?php if($product_selectio_type == 'simple'): ?>
        ...
        <?php if($product_selectio_type == 'variant'): ?>;
    ...
    <div class="varinat-images variant-image-<?php echo e(\Str::slug(implode('-', $items))); ?>">
...
</div><?php /**PATH /Users/asifjamal/Documents/ecommerce/resources/views/admin/product/ajax-variant-calculate.blade.php ENDPATH**/ ?>