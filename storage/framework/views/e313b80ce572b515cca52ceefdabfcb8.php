            ...
            <div class="card-body">
                ...
                <div class="media-area" file-name="slider_image">
                    ...
                    <div class="media-file-value">
                        <?php if($slider->media): ?>
                            <input type="hidden" name="file[]" value="<?php echo e($slider->media_id); ?>" class="fileid<?php echo e($slider->media_id); ?>">
                        <?php endif; ?>
                    </div>
...
<?php $__env->stopPush(); ?>
<?php echo $__env->make('admin.layouts.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /Users/asifjamal/Documents/ecommerce/resources/views/admin/slider/edit.blade.php ENDPATH**/ ?>