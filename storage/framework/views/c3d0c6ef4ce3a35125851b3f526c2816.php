            ...
            <div class="variant-container">
                ...
                <div class="variant-inner col" style="display:none">
                    <div class="form-group<?php echo e($errors->has('variant') ? ' has-error' : ''); ?>">
                        ...
                        <?php echo Form::text('variants', 'Default Title',['class' => 'form-control', 'readonly'=>'readonly']); ?>
                ...
                <div class="variant-inner col">
                    <div class="form-group<?php echo e($errors->has('quantity_on_hand') ? ' has-error' : ''); ?>">
                        ...
                        <?php echo Form::text('quantity_on_hand', null, ['class' => 'form-control','placeholder'=>'Quantity On Hand']); ?>
                ...
                <div class="variant-inner col">
                    <div class="form-group<?php echo e($errors->has('quantity_available') ? ' has-error' : ''); ?>">
                        ...
                        <?php echo Form::text('quantity_available', null, ['class' => 'form-control','placeholder'=>'Quantity Available']); ?>
...
<div class="col-lg-4 col-4">
    ...
    <div class="card">
                    ...
                    <div class="card">
                        <div class="card-body">
                            <div class="form-group<?php echo e($errors->has('product_selectio_type') ? ' has-error' : ''); ?>">
                                ...
                                <?php echo Form::select('product_selectio_type', ['simple'=>'Simple Product', 'variant'=>'Variant Product'], 'simple', ['id' => 'product_selectio_type', 'class' => 'form-control', 'placeholder'=>'Product Selection Type', 'onchange'=>'productSelection($(this))']); ?>
            ...
            <?php $__env->stopPush(); ?>
<?php echo $__env->make('admin.layouts.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /Users/asifjamal/Documents/ecommerce/resources/views/admin/product/create.blade.php ENDPATH**/ ?>