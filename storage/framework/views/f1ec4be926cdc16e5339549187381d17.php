                    ...
                    <div class="card-body">
                        <table id="datatable" class="datatable table table-bordered wrap align-middle" style="width:100%" aria-describedby="scroll-horizontal_info">
                            ...
                            <tr>
                                ...
                                <th>Status</th>
                                <th>Created at</th>
                                <?php if (\Illuminate\Support\Facades\Blade::check('can', ['edit_slider','delete_slider', 'read_slider'])): ?>
                                    <th>Action</th>
                                <?php endif; ?>
                            </tr>
                        </thead>
        ...
        { "data": "created_at" },   
        {
            ...
            render: function(data, type, row) {
                if (type === 'display') {
                    ...
                    <?php if (\Illuminate\Support\Facades\Blade::check('can', 'read_slider')): ?>
...
<?php $__env->stopPush(); ?>
<?php echo $__env->make('admin.layouts.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /Users/asifjamal/Documents/ecommerce/resources/views/admin/slider/list.blade.php ENDPATH**/ ?>