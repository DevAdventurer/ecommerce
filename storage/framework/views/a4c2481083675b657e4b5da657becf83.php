        ...
        <div class="card">
            <div class="card-content">
                <div class="card-body" id="form">
                    ...
                    <?php echo Form::open(['method' => 'POST', 'route' => 'admin.'.request()->segment(2).'.store', 'class' => 'form-horizontal','id'=>'productTypeForm']); ?>

                    
                        <div class="form-group<?php echo e($errors->has('name') ? ' has-error' : ''); ?>">
                            <?php echo Form::label('name', 'Product Type'); ?>

                            <?php echo Form::text('name', null, ['class' => 'form-control slugify', 'required' => 'required','placeholder'=>'Enter Product Type']); ?>
                    ...
                    <table id="dataTableAjax" class="display dataTableAjax table table-striped table-bordered dom-jQuery-events" >
                        <thead>
                            <tr>
                                ...
                                <th>Slug</th>
                                <th>Created at</th>
                                <?php if (\Illuminate\Support\Facades\Blade::check('can', ['edit_product_type','delete_product_type'])): ?>
        ...
        { "data": "created_at" }, 
        {
            ...
            render: function(data, type, row) {
                if (type === 'display') {
                    ...
                    <?php if (\Illuminate\Support\Facades\Blade::check('can', ['edit_product_type','delete_product_type','read_product_type'])): ?>

                    <?php if (\Illuminate\Support\Facades\Blade::check('can', 'read_product_type')): ?>
                    ...
                    <?php if (\Illuminate\Support\Facades\Blade::check('can', 'edit_product_type')): ?>
                    ...
                    <?php if (\Illuminate\Support\Facades\Blade::check('can', 'delete_product_type')): ?>
...
<?php $__env->stopPush(); ?>
<?php echo $__env->make('admin.layouts.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /Users/asifjamal/Documents/ecommerce/resources/views/admin/product-type/list.blade.php ENDPATH**/ ?>