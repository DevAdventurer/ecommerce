    ...
    <div class="col-12">
        <div class="page-title-box d-sm-flex align-items-center justify-content-between">
            ...
            <div class="page-title-right">
                ...
                <a href="<?php echo e(route('admin.product.inventory.create', $product->id)); ?>"  class="btn-sm btn btn-primary btn-label rounded-pill">
                    <i class="bx bx-plus label-icon align-middle rounded-pill fs-16 me-2"></i>
...
<script type="text/javascript">
  ...
  //alert('hello');  
            ...
            var table2 = $('#dataTableAjax').DataTable({
                ...
                "serverSide": true,
                'ajax': {
                    'url': '<?php echo e(route('admin.product.inventory.index', $product->id)); ?>',
                    'data': function(d) {
...
<?php $__env->stopPush(); ?>
<?php echo $__env->make('admin.layouts.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /Users/asifjamal/Documents/ecommerce/resources/views/admin/product/views.blade.php ENDPATH**/ ?>