                    ...
                    <div class="trusted-badge rounded p-0">
                        <div class="trusted-icon">
                            <?php if($section->icon_type == 'image'): ?>
                                <img class="icon-trusted" src="<?php echo e($section->media?$section->media->file:'NA'); ?>" alt="icon-1">
                            <?php endif; ?>
                        </div>
...
<!-- trusted badge end --><?php /**PATH /home/sanix/Documents/ecommerce/resources/views/web/snippets/trusted-badge.blade.php ENDPATH**/ ?>