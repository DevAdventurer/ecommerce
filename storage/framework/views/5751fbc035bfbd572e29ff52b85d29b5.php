                        ...
                        <div class="text-center mt-sm-5 mb-4 text-white-50">
                            <div>
                                <a href="index-2.html" class="d-inline-block auth-logo">
                                    <img src="<?php echo e(asset('admin-assets/images/logo-light.png')); ?>" alt="" height="20">
                                </a>
                            </div>
                ...
                <div class="row justify-content-center">
                    <div class="col-md-8 col-lg-6 col-xl-5">
                        ...
                        <div class="card mt-4">
                             ...
                             <?php if(Session::has('message') && Session::get('class') == 'error'): ?>
                                        ...
                                        <div class="toast-body">
                                            <div class="d-flex align-items-center">
                                                ...
                                                <div class="flex-grow-1">
                                                    <h6 class="mb-0"><?php echo e(Session::get('message')); ?></h6>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                            ...
                            <div class="card-body p-4">
                                ...
                                <div class="p-2 mt-4">
                                    <?php echo Form::open(['method' => 'POST', 'route' => 'admin.login.post', 'class' => 'form-horizontal','id'=>'login', 'autocomplete'=>'off']); ?>


                                    <div class="mb-3 form-group <?php echo e($errors->has('email') ? ' has-error' : ''); ?>">
                                        <?php echo Form::label('email', 'Email address'); ?>

                                        <?php echo Form::email('email', null, ['class' => 'form-control', 'required' => 'required', 'placeholder' => 'eg: foo@bar.com', 'autocomplete'=>'nope']); ?>

                                        <small class="text-danger error"><?php echo e($errors->first('email')); ?></small>
                                    </div>

                                    <div class="mb-3 form-group<?php echo e($errors->has('password') ? ' has-error' : ''); ?>">
                                        <?php echo Form::label('password', 'Password'); ?>

                                        <?php echo Form::password('password', ['class' => 'form-control', 'required' => 'required', 'placeholder'=>'Enter Your Password', 'autocomplete'=>'new-password']); ?>
...
</html><?php /**PATH /Users/asifjamal/Documents/ecommerce/resources/views/admin/auth/login.blade.php ENDPATH**/ ?>