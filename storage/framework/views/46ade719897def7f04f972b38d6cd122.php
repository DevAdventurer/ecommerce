            ...
            <div class="d-flex">
                ...
                <div class="navbar-brand-box horizontal-logo">
                    ...
                    <a href="<?php echo e(route('admin.dashboard.index')); ?>" class="logo logo-light">
                        ...
                        <span class="logo-lg">
                            <img src="<?php echo e(asset(get_app_setting('logo')??'assets/images/logo-light.png')); ?>" alt="" height="17">
                        </span>
                    </a>
                </div>
                ...
                <div class="dropdown ms-sm-3 header-item topbar-user">
                    <button type="button" class="btn" id="page-header-user-dropdown" data-bs-toggle="dropdown"
                        ...
                        <span class="d-flex align-items-center">
                            <img class="rounded-circle header-profile-user" src="<?php echo e(asset(getAdmin('avatar')??'assets/images/users/avatar-1.jpg')); ?>"
...
</header><?php /**PATH /Users/asifjamal/Documents/ecommerce/resources/views/admin/layouts/header.blade.php ENDPATH**/ ?>