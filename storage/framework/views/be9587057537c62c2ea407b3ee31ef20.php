        ...
        { "data": "slug" },  
        {
            ...
            render: function(data, type, row) {
                if (type === 'display') {
                    ...
                    btn += '<li><a class="dropdown-item" href="<?php echo e(request()->url()); ?>/' + row['slug'] + '"><i class="ri-eye-fill align-bottom me-2 text-muted"></i> View</a></li>';
                    <?php endif; ?>
...
<?php $__env->stopPush(); ?>
<?php echo $__env->make('admin.layouts.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /Users/asifjamal/Documents/ecommerce/resources/views/admin/bread/list.blade.php ENDPATH**/ ?>