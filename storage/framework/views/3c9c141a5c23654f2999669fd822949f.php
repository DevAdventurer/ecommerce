                    ...
                    <div class="card-body">
                        <table id="datatable" class="datatable table table-bordered nowrap align-middle" style="width:100%">
                            ...
                            <tr>
                                ...
                                <th>Email</th>
                                <th>Status</th>
                                <?php if (\Illuminate\Support\Facades\Blade::check('can', ['edit_admin','delete_admin', 'read_admin'])): ?>
                                  <th>Action</th>
                                <?php endif; ?>
                            </tr>
                        </thead>
        ...
        { "data": "status" },
        {
            ...
            render: function(data, type, row) {
                if (type === 'display') {
                    ...
                    <?php if (\Illuminate\Support\Facades\Blade::check('can', 'read_admin')): ?>
...
<?php $__env->stopPush(); ?>
<?php echo $__env->make('admin.layouts.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /Users/asifjamal/Documents/ecommerce/resources/views/admin/admin/list.blade.php ENDPATH**/ ?>