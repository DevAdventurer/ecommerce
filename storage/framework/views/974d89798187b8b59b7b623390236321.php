...
<div class="offcanvas mediaselectionlist offcanvas-end" tabindex="-1" id="singlemedia" aria-labelledby="offcanvasRightLabel">
    <div class="offcanvas-header border-bottom">
        <h5 class="offcanvas-title" id="offcanvasRightLabel">Select Single File</h5>
    ...
    <div class="offcanvas-body p-0 overflow-hidden">
        <div data-simplebar class="p-2" style="height: calc(100vh - 116px);padding-bottom: 12px;">
            ...
            <ul id="medias-list-single" class="m-0 p-0 d-flex justify-content-between w-100 flex-wrap"
...
<?php /**PATH /Users/asifjamal/Documents/ecommerce/resources/views/admin/media/select-media-single.blade.php ENDPATH**/ ?>