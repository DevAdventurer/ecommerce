            ...
            <div class="variant-container">
                ...
                <div class="variant-inner col" style="display:none">
                    <div class="form-group<?php echo e($errors->has('variant') ? ' has-error' : ''); ?>">
                        ...
                        <?php echo Form::text('variant', 'Default Title',['class' => 'form-control', 'required' => 'required', 'readonly'=>'readonly']); ?>
...
<div class="col-lg-4 col-4">
    ...
    <div class="card">
            ...
            <?php $__env->stopPush(); ?>
<?php echo $__env->make('admin.layouts.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /Users/asifjamal/Documents/ecommerce/resources/views/admin/product/edit.blade.php ENDPATH**/ ?>