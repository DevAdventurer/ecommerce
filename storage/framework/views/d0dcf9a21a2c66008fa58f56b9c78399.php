                        ...
                        <div class="card-body">
                            <ul class="permissions list-group list-group-flush">
                                <li class="list-group-item">
                                    ...
                                    <label class="m-0" for="<?php echo e($table); ?>"><strong><?php echo e(Str::title(str_replace('_',' ', $table))); ?> </strong></label>
                                    <ul class="list-group list-group-flush">
                                        ...
                                        <li class="list-group-item">
                                            <input type="checkbox" id="permission-<?php echo e($permission->permission_key); ?> " name="permissions[]" class="the-permission" <?php echo e($permission->checked? 'checked' :''); ?> value="<?php echo e($permission->permission_key); ?>" >
                                            <label class="m-0" for="permission-<?php echo e($permission->permission_key); ?>"><?php echo e(Str::title(str_replace('_',' ', $permission->permission_key))); ?></label>
                                        </li>
...
<?php $__env->stopPush(); ?>
<?php echo $__env->make('admin.layouts.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /Users/asifjamal/Documents/ecommerce/resources/views/admin/role/edit.blade.php ENDPATH**/ ?>