            ...
            <div class="row my-1">
                <div class="col-lg-7 col-7">
                    ...
                    <div class="card">
                        ...
                        <div class="form-group{{ $errors->has('subtitle') ? ' has-error' : '' }}">
                            ...
                            {!! Form::text('subtitle', null, ['class' => 'form-control', 'placeholder'=>'Post Subtitle']) !!}
                        ...
                        <div class="btn-group">
                            {!! Form::submit("Add Post", ['class' => 'btn btn-soft-secondary waves-effect waves-light']) !!}
                        </div>
                            </div>
                        </div>
                    </div>
                ...
                <div class="col-lg-5 col-5">
                    ...
                    <div class="form-group{{ $errors->has('status') ? ' has-error' : '' }}">
                        ...
                        {!! Form::select('status', [0=>'Draft', 1=>'Public'], null, ['id' => 'my-status', 'class' => 'form-control', 'placeholder' => 'Choose Status']) !!}
                    ...
                    <div class="form-group{{ $errors->has('categories') ? ' has-error' : '' }}">
                        ...
                        {!! Form::select('categories[]', App\Models\Category::pluck('name','id'), null, ['id' => 'categories','data-placeholder'=>'Select Category', 'class' => 'form-control js-example-basic-multiple',  'multiple']) !!}
