...
@section('main')
            ...
            @include('web.snippets.slider')

            @include('web.snippets.trusted-badge')

            @include('web.snippets.new-arrivals')

            @include('web.snippets.single-banner')

            @include('web.snippets.featured-products')

            @include('web.snippets.testimonials')
