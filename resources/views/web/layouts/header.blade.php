...
@include('web.snippets.announcement')
                ...
                <div class="col-lg-6 d-lg-block d-none">
                    <nav class="site-navigation">
                        <ul class="main-menu list-unstyled justify-content-center">
                            <li class="menu-list-item nav-item @yield('activeHome')">
                                <a class="nav-link" href="{{route('web.home')}}">Home</a>
                            </li>

                            <li class="menu-list-item nav-item @yield('activeShop')">
                                <a class="nav-link" href="contact.html">Shop</a>
                            </li>

                            <li class="menu-list-item nav-item @yield('activeAbout')">
                                <a class="nav-link" href="contact.html">About</a>
                            </li>

                            <li class="menu-list-item nav-item @yield('activeBlog')">
                                <a class="nav-link" href="contact.html">Blog</a>
                            </li>

                            <li class="menu-list-item nav-item @yield('activeContact')">
