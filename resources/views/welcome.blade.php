    ...
    <div class="row g-2">
        ...
        <div class="variant-inner col">
            <div class="form-group{{ $errors->has('quantity_on_hand') ? ' has-error' : '' }}">
                ...
                {!! Form::text('variants['.$count.'][quantity_on_hand]', null, ['class' => 'form-control', 'required' => 'required']) !!}
        ...
        <div class="variant-inner col">
            <div class="form-group{{ $errors->has('quantity_available') ? ' has-error' : '' }}">
                ...
                {!! Form::text('variants['.$count.'][quantity_available]', null, ['class' => 'form-control', 'required' => 'required']) !!}
        ...
        <div class="variant-inner col">
            <div class="form-group{{ $errors->has('sku') ? ' has-error' : '' }}">
                {!! Form::label('sku', 'SKU') !!}
                {!! Form::text('variants['.$count.'][sku]', null, ['class' => 'form-control', 'required' => 'required']) !!}
        ...
        <div class="variant-inner col">
            <div class="form-group{{ $errors->has('variant_price') ? ' has-error' : '' }}">
                ...
                {!! Form::text('variants['.$count.'][variant_price]', null, ['class' => 'form-control', 'required' => 'required']) !!}
        ...
        <div class="variant-inner col">
            <div class="form-group{{ $errors->has('variant_sale_price') ? ' has-error' : '' }}">
                ...
                {!! Form::text('variants['.$count.'][variant_sale_price]', null, ['class' => 'form-control', 'required' => 'required']) !!}
